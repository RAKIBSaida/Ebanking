...
public class CompteController {
    ...
    public List<Compte> findAllAccunt()
    {
	 ...
	 @RequestMapping(value="/Account/{id}",method = RequestMethod.GET)
	   ...
	   @RequestMapping(value="/Operation/{idOperation}", method=RequestMethod.GET)
	    public Operation getOperationbyId(@PathVariable long idOperation)
	    {
   ...
   public List<Virement> getOperation(@PathVariable long idCompte)
    {
   ...
   public CarteBancaire getCarteBancaire(@PathVariable long idCompte)
    {
